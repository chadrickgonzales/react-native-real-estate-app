...
const propertyTypes = [
  "House", "Apartment", "Villa", "Condos", "Duplexes", "Studios", "Townhomes"
];
...
const utilitiesOptions = [
  "Electricity", "Gas", "Water", "Internet", "Cable TV", "Trash", "Sewer"
];

const moveInRequirements = [
  "Credit Check", "Background Check", "References", "Employment Verification", 
  "Income Verification", "Security Deposit", "First Month Rent", "Last Month Rent"
];
...
const propertyNamePrefixes = [
  "Casa", "Villa", "Residence", "Manor", "Garden", "Park", "Heights", "View",
  "Plaza", "Terraces", "Estates", "Haven", "Retreat", "Oasis", "Sanctuary",
  "Palace", "Court", "Square", "Place", "Homes"
];

const propertyNameSuffixes = [
  "de Tarlac", "del Norte", "de la Paz", "de San Miguel", "de San Nicolas",
  "de San Sebastian", "de Rizal", "de Burgos", "de Mabini", "de Luna",
  "de Bonifacio", "de Quezon", "de MacArthur", "de la Salle", "de San Jose",
  "de San Antonio", "de San Pedro", "de San Pablo", "de San Juan", "de San Francisco"
];

const propertyNameMiddle = [
  "Grand", "Royal", "Elite", "Premium", "Luxury", "Modern", "Classic",
  "Elegant", "Charming", "Beautiful", "Spacious", "Cozy", "Bright",
  "Serene", "Peaceful", "Tranquil", "Exclusive", "Private", "Secure", "Family"
];
...
async function seedProperties() {
  ...
  for (let i = 1; i <= 50; i++) {
    const selectedAmenities = getRandomSubset(amenities, 3, 7);
    ...
    const baseLat = 15.4869 + (Math.random() - 0.5) * 0.05;
