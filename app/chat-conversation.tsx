...
const Chat = () => {
  ...
  const renderMessage = ({ item, index }: { item: ChatMessage; index: number }) => {
    ...
    if (isBookingMessage) {
      ...
      return (
        <View className="mb-6">
          {/* Property Card Style Booking Message - Exact pixel-perfect layout */}
          ...
          <Text className="text-gray-400 font-rubik text-xs mt-2 text-center">
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      >
        <View className="px-4 py-4 bg-white border-t border-gray-100">
          <View className="flex-row items-end bg-gray-100 rounded-3xl px-4 py-3">
            ...
            <TextInput
              ...
              className="flex-1 font-rubik text-base text-gray-900 min-h-[24px] max-h-[120px]"
              multiline
              maxLength={500}
              style={{ lineHeight: 20 }}
            />
            ...
            {message.trim() ? (
              ...
              >
                <LinearGradient
                  colors={sending ? ['#9CA3AF', '#9CA3AF'] : ['#3B82F6', '#2563EB']}
                  className="w-10 h-10 rounded-full items-center justify-center"
                  style={{ shadowColor: '#3B82F6', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4 }}
                >
